...
namespace GameTech.Elite.Client.Modules.B3Center.UI.SettingViews
{
    ...
    public partial class SettingView //: UserControl
    {
        ...
        public SettingView()
        {
            ...
            if (b3GameSetting.B3SettingGlobal_[142].B3SettingValue != "T")//Fixed value (142 == NDSetting). *Note 142 is not a setting ID
            {
        ...
        void m_btnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            else if (m_toggleButton.Name == "SystemSettingToggleButton")
            {
                if (m_systemSettingView.isNDSettingEnable == true)
                {
