...
namespace GameTech.Elite.Client.Modules.B3Center.UI.ReportViews
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MonthlyReportView"/> class.
        /// </summary>
        public MonthlyReportView(ReportBaseVm bcvm)
        {
            InitializeComponent();
            DataContext = bcvm;
        ...
        //        try
        //        {
        //            var report = viewModel.LoadMonthlyReportDocument();
        ...
        //            if (!viewModel.PrintReport(Elite.Reports.ReportId.B3Monthly, report))
        //            {
